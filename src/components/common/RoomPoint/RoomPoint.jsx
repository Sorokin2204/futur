...
const RoomPoint = ({ onClick, className, label, value, x, y, name }) => {
  const randomId = generateRandomString(5);
  return (
    <>
      <label onClick={onClick} htmlFor={randomId} className={clsx(styles.roomPointLabel, className)} style={{ top: y + '%', left: x + '%' }}>
